...
## 테스트 케이스 목록
- [x] 정상 케이스: null, true, false 직렬화
- [x] 정상 케이스: 정수/실수/음수 직렬화
- [x] 정상 케이스: 일반 문자열 직렬화
- [x] 정상 케이스: 이스케이프가 필요한 문자열 직렬화
- [x] 정상 케이스: 배열 직렬화 (빈 배열 포함)
- [x] 정상 케이스: 객체 직렬화 (빈 객체 포함)
- [x] 정상 케이스: 배열/객체 중첩 구조 직렬화
- [x] round-trip 케이스: JsonWriter로 직렬화한 문자열을
